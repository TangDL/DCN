...
config.network.pretrained = '/home/dell/DaringTang/works/Detection/code/DCN/model/pretrained_model/resnet_v1_101-0000.' \
                            'params'
...
config.dataset.dataset = 'Aldetection'
config.dataset.image_set = 'guangdong_round2_train_20181011'
config.dataset.test_image_set = 'guangdong_round2_train_20181011'
config.dataset.root_path = '/home/dell/DaringTang'
config.dataset.dataset_path = './data'
