...
class StepSaveCkpt(object):
    ...
    def __init__(self, mod, mean, std, frequent=1000):
        ...
        self.prefix = "/root/project/code/DCN/fpn/trained_model/weights-fpn-dcn-{}-{}.params"
        self.mean = mean
        self.std = std
        self.mod = mod
    ...
    def __call__(self, param):
        ...
        if count % self.frequent == 0:
            ...
            save_path = self.prefix.format(epoch, count)
...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch, lr, lr_step):
    ...
    if config.TRAIN.RESUME:
        ...
        print('load from coco pretrained model')
    ...
    batch_end_callback = [callback.Speedometer(train_data.batch_size, frequent=args.frequent), StepSaveCkpt(mod, means, stds)]
