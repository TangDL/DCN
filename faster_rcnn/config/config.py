...
config = edict()                      # 以edict的方式配置config

config.MXNET_VERSION = 'mxnet-cu80'
config.output_path = ''
config.symbol = ''
config.gpus = ''
...
config.dataset.image_set = '2007_trainval'                       # 数据集中的训练集
config.dataset.test_image_set = '2007_test'                      # 数据集中的测试集
config.dataset.root_path = './data'                              # 确定数据集的路径
config.dataset.dataset_path = './data/VOCdevkit'                 # 确定数据集路径的的数据集
